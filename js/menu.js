	function loadUiFunctions() {
		...
		$(document).ready(function(){
			...
			$(document).on("click", "img.close-dialog", function(e){
				$('.show-guide').removeClass('show-guide');
			});

			$(document).on("click", ".youarehere-btn", function(e){

				$('.showlegend').removeClass('showlegend');

				if (typeof youAreHereLat != 'undefined' && youAreHereLat.length > 0) {
					ambiarc.focusOnLatLonAndZoomToHeight('', '', youAreHereLat, youAreHereLon, 150);
				} else {
					ambiarc.focusOnLatLonAndZoomToHeight('', '', 40.690354, -73.964872, 150);
				}

			});

			$(document).on("click", "li.list-group-item, span.fly-sculp, .cat-box, .fly-box, .youarehere-btn", function(e){
			...
			$(document).on("click", "li.list-group-item, span.fly-sculp", function(e){
				...
				if (typeof personAttr != 'undefined' || typeof professorAttr != 'undefined') {
					...
					if ($(this).attr('data-building') != '') {
						...
						if ($(this).attr('data-building') == 'PFZR' ||
						    $(this).attr('data-building') == 'FLSH' ||
						    $(this).attr('data-building') == 'CRR' ||
						    $(this).attr('data-building') == 'W14' ||
						    $(this).attr('data-building') == 'W18' ||
						    $(this).attr('data-building') == '100G') {
			...
			$(document).on('click', '.gesture-btn', function() {
				$('div.gestures').addClass('show-guide');
			});
			...
			$(document).on('click', '.cat-box', function() {
				...
				var maxHei = parseInt($(document).height() - pos1.top);
			...
			function doMenuOffsetThing(){
				...
				$('div.search-list').css({
					'max-height':parseInt(maxHei-80),
				});

				var alignMenu = setInterval(function(){
					var pos1 = $('.menu-top').offset();
					var maxHei = parseInt($(document).height() - pos1.top);
					$('div.flyout').css({
						'height':maxHei,
			...
			$(document).on('click', '.fly-box', function(e) {
				...
				if (cat == 'school') {
					...
					if ($(this).attr('data-bldg') == 'FLSH' ||
					    $(this).attr('data-bldg') == 'CRR' ||
					    $(this).attr('data-bldg') == 'W14' ||
					    $(this).attr('data-bldg') == 'W18' ||
					    $(this).attr('data-bldg') == '100G'
					    ) {
					...
					if ( $(this).attr('data-cat') == 'buildings' || $(this).attr('data-cat') == 'proh' ) {
						...
						if ( $(this).closest('div').hasClass('accessibility') ) {
							...
							params.accesspoint		= $(this).attr('data-accesspoint');
							params.elevator			= $(this).attr('data-elevator');
							params.destination		= $(this).attr('data-destination');

							params.overhead			= $(this).attr('data-overhead');
							params.zoom				= $(this).attr('data-zoom');
							params.rotation			= $(this).attr('data-rotation');

							if ($(this).attr('data-legendcopy') != '') {
								legendCopy			= $(this).attr('data-legendcopy');
								params.legendCopy	= $(this).attr('data-legendcopy');
							} else {
								legendCopy			= '';
								params.legendCopy	= '';
							}
...
//  		prattCopy['pps'] = 'The Pratt Institute Department of Public Safety provides 24&#8209;hour protection to the campus. Public Safety Officers are charged with the enforcement of Pratt Institute rules and regulations. They are staff employees and are responsible for a full range of services, including preparation of crime and condition reports, response to emergencies, conducting fire drills, and any other situation requiring security assistance. Contact us at security@pratt.edu or at 718.636.3540.';
		...
		prattCopy['0001'] = 'Date: 1954-55. Renovated 1973 <br>Architects: Firm of McKim, Mead and White <br><br>Built as a dormitory for women at the same time DeKalb Hall was built for men. By the 1960s after the acquisition of Willoughby Hall, both buildings were being used for offices and classrooms. They had been built during the extensive Pratt Area Urban Renewal under the direction of Robert Moses.';

		prattCopy['0002'] = 'Date: 1896. Renovated 1982 <br>Architect: William B. Tubby, Interiors by Tiffany firm. <br><br>The Victorian Renaissance revival structure was the first free Library in New York City. As the Institute grew and the public library system expanded it ceased being a public library in 1941. The interiors, originally designed by the Louis Tiffany firm have a marble and brass central staircase, and floors decorated with mosaic and glass. The building was designated a New York City Landmark in 1986.';

		prattCopy['0003'] = 'Date: 1954-55 <br>Architects: Firm of McKim, Mead and White <br><br>Originally a men\'s dormitory designed by the same firm which built the Information Science Building and North Hall during the urban renewal project which radically reshaped the campus.';

		prattCopy['0004'] = 'Date: 1868-1890 <br>Architects: Mundell and Teckritz, Ebenezer L. Roberts, <br>Charles C. Haight and William B. Tubby. <br><br>This was Adelphi Academy, a private school which has evolved into Adelphi University in Garden City, and Adelphi Academy in Bay Ridge, Brooklyn. The original academic building was by Mundell and Teckritz, built in 1868. Pratt acquired the building in the l960s and it houses much of the School of Architecture.';

		prattCopy['0005'] = 'Date: 1958 <br>Architects: Firm of McKim, Mead and White <br><br>Built a little later than DeKalb Hall and the ISC Building by the same architects. Although this firm retained the name of one of America\'s most important firms, it was long after the demise of the famous Charles Follen McKim (1847-1909) and Stanford White (1853-1906).';

		prattCopy['0006'] = 'Date: 1926-7 <br>Architect: John Mead Howells <br>Sculptor: Rene Chambellan <br><br>A large auditorium/theater built by the Pratt family in memory of Mary Richardson Pratt, the wife of the founder, Charles Pratt.';

		prattCopy['0007'] = 'Date: 1887 <br>Architect: William B. Tubby <br><br>Built originally as the Trade School Building with a handsome wood truss roof,this was used for courses on bricklaying, plumbing and sign painting before it became the old gymnasium. There was a small swimming pool (actually called a\"swimming tank\" and the first to admit women in Brooklyn) located under the staging area on the east side of the building.';

		prattCopy['0008'] = 'Date: 1887 <br>Architects: Hugo Lamb and Charles A. Rich <br><br>Lamb and Rich was a noted architectural firm in the late 19th century, and here it reflected the influence of H. H. Richardson. This is the original Pratt Institute building constructed of brick in the Romanesque revival style. The porch was added in 1895.';

		prattCopy['0009'] = 'Date: 1887 <br>Architect: William Windrim <br><br>Although this is part of the original building complex and is connected to the Main Building, it had a different architect. It is an \"L\" shaped structure and the fifth floor or the north/south section was a later addition. The building wraps around an attractive courtyard and the first floor houses Pratt\'s Power Generating Plant, a National Historic Mechanical Engineering Landmark.';

		prattCopy['0010'] = 'Date: 1889-92 <br>Architect: William B. Tubby <br><br>Designed by the same architect as the Library, this was originally the Pratt High School, a three-year coed program. When that was discontinued, this became the Household Science and then the Costume Design Building.';

		prattCopy['0011'] = 'Date: 1921 <br>Architect: unknown <br><br>A private apartment building which had the address of 243 Ryerson Street. It was purchased by Pratt Institute in 1964 and became a residence hall.';

		prattCopy['0012'] = 'Date: 1916-17 <br>Architects: Shampan and Shampan <br><br>This was a savings bank which had been founded on the campus by Charles Pratt in 1889, meant to teach students and others the value of thrift.';

		prattCopy['0013'] = 'Date: 1986-87 <br>Architects: Skidmore, Owings and Merrill <br><br>A contemporary residence for students, situated on DeKalb Avenue between Thrift Hall and the Studio Building. The attractive brick structure fits well into the campus, and the clock tower echoes the clock on the Main Building.';

		prattCopy['0014'] = 'Date: 1957 <br>Architect: S. J. Kessler <br><br>Built as a private apartment building during the urban renewal project under Robert Moses. The building was acquired as the main residence hall for Pratt Institute in the early 1960s.';

		prattCopy['0015'] = 'Date: 1904-05 <br>Architects: Howells and Stokes <br><br>John Mead Howells (1868-1959) and I.N. Phelps Stokes (1867-1944) were each noted architects earlier in the twentieth century. Working together, they built this as the first of the three buildings which have been known as the Engineering complex. Despite its name, this building is no longer used for the study of chemistry. The building was extensively remodeled in 1985-86.';

		prattCopy['0016'] = 'Date: 1914 <br>Architects: Howells and Stokes <br><br>The architects who had, a decade before, designed the Chemistry Building built this as the Manual Training Building. Connected to the Chemistry and Engineering buildings, for many years it was filled with heavy industrial machinery for student use.';

		prattCopy['0017'] = 'Date: 1928-29. Extended in 1935. <br>Architect: John Mead Howells <br><br>The most recent of the three buildings in this group. It connects to the Machinery and Chemistry buildings.';

		prattCopy['0018'] = 'Previously, this was the United Metals factory, which manufactured small metal items and was acquired by Pratt in the early 1970s. <br>Former industrial building acquired by Pratt in 1962, and converted for use as art and design studios.';

		prattCopy['0019'] = 'Date: 2015 <br>Architect: WASA/Studio, Jack Esterson<br>lead architect and Pratt alumnus  <br><br>Pratt Institute recently opened a new home for the Film/Video Department in the former Prattstore building at 550 Myrtle Avenue on the Brooklyn campus. The 15,000-square-foot facility was designed by WASA/Studio A with lead architect and Pratt alumnus Jack Esterson. The project was recognized with a citation award in the 2015 American Institute of Architects New York State Design Awards.';

		prattCopy['0020'] = '--';

		prattCopy['0021'] = 'Date: 1974-75 <br>Architects: Ezra Ehrenkranz (lower level), Daniel Tully (upper level) <br><br>This large building was built to serve many functions. The upper level is a huge gymnasium, while the lower level has classrooms and laboratories. The concrete exterior has no windows and displays a fanciful tent-like roofing system.';

		prattCopy['0022'] = 'Date: 1999. Named for the donor and graduate of the Engineering School, Stabile Hall was designed to house new undergraduate students. The award-winning design of the building boasts a large common lounge with smaller work and lounge spaces on each floor, all of which contribute to a vital living and working environment.';

		prattCopy['0023'] = 'Date: 1986-87 <br>Architects: Skidmore, Owings and Merrill <br><br>A rather stark-looking residence hall on the most eastern part of the campus on an area which had been an athletic field. It is connected to the ARC building and was built from prefabricated units.';

		prattCopy['0024'] = 'Architect: WASA/Studio, Jack Esterson<br><br>The building was designed by multi-disciplinary architectural firm WASA/Studio A under the leadership of principal Jack Esterson, who received a bachelor\'s degree in architecture from Pratt in 1975. <br>Myrtle Hall recently met the United States Green Building Council standards for LEED (Leadership in Energy and Environmental Design) Gold certification based on its eco-features that include exterior sun shades; a green roof that absorbs rainwater, reflects heat, and sequesters greenhouse gasses; and solar photo-voltaic panels that generate on-site electricity.';
	...
	function doPopupMap() {
		...
		$('.showpopmap').removeClass('showpopmap').promise().then(function(){
			...
			if (bldg=='100G') {
				...
				//$('div.mapouter').find('iframe').attr('src',bmap);
				$('div.mapouter').css({'background-image':'url("images/100g.png")'});
				$('div.mapouter').addClass('showpopmap');
				ambiarc.buildingId = '100 Grand Ave.';
				ambiarc.floorId = '100G';
				ambiarc.roomName = '100 Grand Ave.<br>Brooklyn, NY 11205';
			}

			if (bldg=='W18') {
				//window.bmap = 'https://maps.google.com/maps?q=144%20West%2014th%20Street&t=&z=15&ie=UTF8&iwloc=&output=embed';
				//$('div.mapouter').find('iframe').attr('src',bmap);
				$('div.mapouter').css({'background-image':'url("images/w18.png")'});
				$('div.mapouter').addClass('showpopmap');
				ambiarc.buildingId = 'Pratt Manhattan<br>18th St.';
				ambiarc.floorId = 'W18';
				ambiarc.roomName = '123 West 18th Street<br>New York, NY 10011';
			}
			...
			if (bldg=='W14') {
				...
				$('div.mapouter').addClass('showpopmap');
				ambiarc.buildingId = 'Pratt Manhattan<br>14th St.';
				ambiarc.floorId = 'W14';
